...
//         // edit button
//         this.editButton = this.createAButton(
//             "fa-solid fa-pen",
//             ModeButtonsState.edit
//         );
//         this.groupDiv.appendChild(this.editButton);

//         // brush button
//         this.brushButton = this.createAButton(
//             "fa-solid fa-brush",
//             ModeButtonsState.brush
//         );
//         this.groupDiv.appendChild(this.brushButton);

//         // delete button
//         this.deleteButton = this.createAButton(
//             "fa-solid fa-trash",
//             ModeButtonsState.delete
//         );
//         this.groupDiv.appendChild(this.deleteButton);

//         // label button
//         this.labelButton = this.createAButton(
//             "fa-solid fa-font",
//             ModeButtonsState.label
//         );
//         this.groupDiv.appendChild(this.labelButton);

//         // view button
//         this.viewButton = this.createAButton(
//             "fa-solid fa-eye",
//             ModeButtonsState.view
//         );
